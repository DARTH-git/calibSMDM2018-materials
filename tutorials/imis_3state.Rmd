...
Incremental mixture importance sampling is a Bayesian method that allows us to account for non-identifiability and uncertainty in the calibrated values.
